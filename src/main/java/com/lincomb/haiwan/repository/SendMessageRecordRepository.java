...
public interface SendMessageRecordRepository extends JpaRepository<SendMessageRecord, Integer> {
    ...
    SendMessageRecord findDistinctTopByMobileOrderByEndSetupTimeDesc(String mobile);

    SendMessageRecord findDistinctTopByMobileAndInvalidFlagOrderByEndSetupTimeDesc(String mobile, Integer invalidFlag);
}
